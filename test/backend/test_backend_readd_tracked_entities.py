...
class TestBackendReaddTrackedEntities(unittest.TestCase):
    ...
    def test_readd_tracked_entities_success(self, add_tracked_entity_mock, _):
        ...
        self.assertEqual(-1, entities["domain1"]["domain1.entity1"][backend_const.SUBSCRIPTION_ID])
        self.assertEqual("2.3", entities["domain1"]["domain1.entity2"][backend_const.SUBSCRIPTION_ID])
        self.assertEqual(-1, entities["domain2"]["domain2.entity3"][backend_const.SUBSCRIPTION_ID])
        self.assertEqual(set(), entities["domain1"]["domain1.entity1"][backend_const.ACTIONS])
