...
class TestParameterSwitchRow(unittest.TestCase):
    ...
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.ParameterRow.__init__')
    ...
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow.get_active')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.ParameterRow.__init__')
    ...
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow.set_value')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.ParameterRow.__init__')
    ...
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow._value_changed')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.ParameterRow._on_change')
    @patch(
        'HomeAssistantPlugin.actions.perform_action.parameters.parameter_switch_row.ParameterRow.__init__')
